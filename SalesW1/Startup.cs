...
namespace SalesW1
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            //        options.UseSqlServer(Configuration.GetConnectionString("SalesW1Context")));
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env, SeedindService seedindService)
        {
            ...
            var localizOptions = new RequestLocalizationOptions
            {
                DefaultRequestCulture = new RequestCulture(enUS),
                SupportedCultures = new List<CultureInfo> { enUS },
                SupportedUICultures = new List<CultureInfo> { enUS }
            };
            app.UseRequestLocalization(localizOptions);
