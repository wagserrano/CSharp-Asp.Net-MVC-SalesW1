...
namespace SalesW1.Data
{
    public class SeedindService
    {
        ...
        public void Seed()
        {
            ...
            //SalesRecord sr1 = new SalesRecord(1, new DateTime(2020, 9, 21), 10000.0, SaleStatus.Billed, s1);
            //SalesRecord sr2 = new SalesRecord(2, new DateTime(2020, 9, 21), 17000.0, SaleStatus.Billed, s2);
            //SalesRecord sr3 = new SalesRecord(3, new DateTime(2020, 9, 21), 8000.0, SaleStatus.Billed, s3);
            //SalesRecord sr4 = new SalesRecord(4, new DateTime(2020, 9, 21), 6500.0, SaleStatus.Billed, s4);
            //SalesRecord sr5 = new SalesRecord(5, new DateTime(2020, 9, 21), 12000.0, SaleStatus.Billed, s5);
            //SalesRecord sr6 = new SalesRecord(6, new DateTime(2020, 9, 21), 9000.0, SaleStatus.Billed, s6);
